...
export default function DashboardLayout({ children }: { children: ReactNode }) {
    ...
    useEffect(() => {
      ...
      return (
        <div className="flex w-100% flex-col bg-background-light ">
            <HeaderBoard
                handleDarkMode={() => null}
            ...
            <div className="mt-[64px] flex">
                ...
                <div className={`flex flex-1 p-4 flex-col overflow-y-auto bg-background  h-[calc(100vh-64px)] ${parentActive === 'CloseAll' ? "lg:ml-[64px]" : "lg:ml-[320px]"}`}>
                {children}
